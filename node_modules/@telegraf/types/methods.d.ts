import type { InlineQueryResult, InlineQueryResultsButton } from "@telegraf/types/inline.js";
import type { ForceReply, InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove } from "@telegraf/types/markup.js";
import type { BotCommand, ChatAdministratorRights, ChatFromGetChat, ChatInviteLink, ChatMember, ChatMemberAdministrator, ChatMemberOwner, ChatPermissions, File, ForumTopic, ReactionType, UserChatBoosts, UserFromGetMe, UserProfilePhotos, WebhookInfo } from "@telegraf/types/manage.js";
import type { GameHighScore, LinkPreviewOptions, MaskPosition, Message, MessageEntity, MessageId, ParseMode, Poll, ReplyParameters, SentWebAppMessage, Sticker, StickerSet } from "@telegraf/types/message.js";
import type { PassportElementError } from "@telegraf/types/passport.js";
import type { LabeledPrice, ShippingOption } from "@telegraf/types/payment.js";
import type { BotCommandScope, BotDescription, BotName, BotShortDescription, MenuButton } from "@telegraf/types/settings.js";
import type { Update } from "@telegraf/types/update.js";
