import { ForceReply, InlineKeyboardButton, InlineKeyboardMarkup, KeyboardButton, ReplyKeyboardMarkup, ReplyKeyboardRemove } from 'telegraf/src/core/types/typegram';
type Hideable<B> = B & {
    hide?: boolean;
};
...
export * as button from 'telegraf/src/button';
